(function(){
  ...
  const PLAYSTATION_ICON='<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3.4 9.3 8.2h5.4Z"/><circle cx="18.2" cy="12" r="2.6"/><path d="M9.6 15.8 14.4 20.6M14.4 15.8 9.6 20.6"/><rect x="3.4" y="9.4" width="5.2" height="5.2" rx=".4"/></svg>';
