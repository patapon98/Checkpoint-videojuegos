    ...
    <div class="wrap event-hero-grid">
      <div>
        ...
        <div class="event-actions">
          <a class="event-btn" href="#anuncios">${isFinished ? "Ver los anuncios" : "Seguir los anuncios"}</a>
...
`}
  ...
  <div class="wrap event-main">
    <nav class="event-nav" aria-label="Secciones del especial">
      <a href="#anuncios">Anuncios</a>${isFinished ? "" : `<a href="#confirmados">Confirmados</a>`}<a href="#directo">Emisión</a><a href="#fuentes">Fuentes</a>
    </nav>

    <section class="event-section" id="anuncios">
      <div class="event-section-heading reveal">
        <div><span class="event-kicker">${isFinished ? "Resumen de la gala" : "Cobertura en directo"}</span><h2>${isFinished ? "Los anuncios más relevantes" : "Todos los anuncios de la gala"}</h2><p>${isFinished ? "La selección está ordenada por relevancia editorial. Los anuncios menores y el pre-show aparecen al final." : "Las novedades aparecerán en orden conforme se confirmen durante la emisión."}</p></div>
...
<footer><div class="footer-inner"><span>© 2026 Final Secreto</span></div></footer>
<script src="/js/main.js?v=20260823-1"></script>
<script src="/js/event-hub.js?v=20260826-1"></script>
</body>
</html>
`;
}
